...
<style type="text/css">
	...
	.page__options .option-button1,.option-button2,.option-button3 {
	    float: left;
	    margin-right: 10px;
	}
	
	.option-button1,.option-button2,.option-button3 {
	    border-color: #525f78;
	    background: #525f78;
	    color: #fff;
	}
	...
	.option-button1:focus,.option-button2:focus,.option-button3:focus {
		outline: none;
		background: #3C5087;
		color: white;
	}
