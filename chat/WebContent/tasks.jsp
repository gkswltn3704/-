...
<!-- 						<span class="ir-pm">검색</span> -->
		...
		<div class="paginated-list-footer">
			<div class="no-content-placeholder no-content-placeholder--visible" id="contents">
				...
				<p class="no-content-placeholder__message" id="nocontent">요청 받은 게시물이 없습니다.</p>
...
/*         console.log(this.value); */
		window.location.href="tasks.jsp?status=";				//다시 원래 페이지로 돌아오기
	});  
  	
    $('.option-button2').click(function(){
/*         console.log(this.value); */
    	$('#div1').load('status0.jsp?status='+this.value);
    });
	
    $('.option-button3').click(function(){
/*         console.log(this.value); */
        $('#div1').load('status1.jsp?status='+this.value);
   });
    
    
 	$('.option-button4').click(function(){
 /*        console.log(this.value); */
        $('#div1').load('status2.jsp?status='+this.value);
   });
